...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/17 11:33:30 by yunguo            #+#    #+#             */
/*   Updated: 2025/12/17 11:33:30 by yunguo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	gi->c = load_img(g, gi, "textures/coin.xpm");
	gi->e = load_img(g, gi, "textures/exit.xpm");
	gi->f = load_img(g, gi, "textures/flor.xpm");
	gi->m = load_img(g, gi, "textures/mobs.xpm");
	gi->p = load_img(g, gi, "textures/plyr.xpm");
	gi->w = load_img(g, gi, "textures/wall.xpm");
